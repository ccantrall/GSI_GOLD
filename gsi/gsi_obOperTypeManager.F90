...
! Added by cantrall 07/20/2021
  use gsi_fuvOper     , only: fuvOper
...
! Added by cantrall 07/20/2021
  type(    fuvOper), target, save::       fuvOper_mold
...
! Added by cantrall 07/20/2021
  case("fuv"    ,"[fuvoper]"    ); index_= iobOper_fuv
...
! Added by cantrall 07/20/2021
  case(iobOper_fuv      ); vmold_ =>     fuvOper_mold
...
! Added by cantrall 07/20/2021
    cobstype(iobOper_fuv        )  ="fuv                 " ! fuv_ob_type

...
!   endif
    blacklst  = .false.
! Changed by cantrall 07/02/2021 from lobserver=false to lobserver=true
    lobserver = .true.     ! when .t., calculate departure vectors only
...
! Added by cantrall 07/29/2020
    mype_gold=max(0,npe-34) ! gold fuv
